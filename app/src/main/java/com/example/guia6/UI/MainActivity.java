    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAcercaDe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(com.example.guia6.UI.MainActivity.this, AcercaDeActivity.class);
        ...
        btnMainActivity2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.example.guia6.UI.MainActivity.this, MainActivity2.class);
                startActivity(intent);
            }
        });
        btnPoliticasDe.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(com.example.guia6.UI.MainActivity.this, PoliticasDeActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void signOut() {
        ...
        mGoogleSignInClient.signOut().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                com.example.guia6.UI.MainActivity.this.finish();
            }
        });
    }
}