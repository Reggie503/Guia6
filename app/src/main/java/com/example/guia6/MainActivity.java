...
import com.example.guia6.UI.AcercaDeActivity;
import com.example.guia6.UI.MainActivity2;
import com.example.guia6.UI.PoliticasDeActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void signOut() {
        ...
        mGoogleSignInClient.signOut().addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                Intent loginActivity = new Intent(getApplicationContext(), com.example.guia6.UI.loginActivity.class);
